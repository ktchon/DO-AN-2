          ...
          showAction
              ? SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(side:BorderSide(color: Colors.blueAccent),backgroundColor: Colors.blueAccent),
                    child: Text(
                      actionText!,
                      style: Theme.of(
                        context,
                      ).textTheme.bodyMedium!.apply(color: TColors.lightContainer),
                    ),
                  ),
                )
              : const SizedBox(),
